...
//  BetterBlueKit
//
//  Hyundai Canada API Client (Stub)
//
...
public final class HyundaiCanadaAPIClient: APIClientBase, APIClientProtocol {
    ...
    public func login() async throws -> AuthToken {
        throw APIError.regionNotSupported(
            "Hyundai Canada is not yet implemented. " +
    ...
    public func fetchVehicles(authToken: AuthToken) async throws -> [Vehicle] {
        throw APIError.regionNotSupported("Hyundai Canada is not yet implemented.", apiName: apiName)
    }
