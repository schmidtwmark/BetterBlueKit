...
struct VehicleCommandsTests {
    ...
    func testClimateOptionsCodable() throws {
        ...
        #expect(decoded.heating == original.heating)
    ...
    func testGetBodyForCommandStartClimateElectricGen3() {
        ...
        if let seatInfo = body["seatHeaterVentInfo"] as? [String: Any] {
            #expect(seatInfo["drvSeatHeatState"] as? Int == 2)
            #expect(seatInfo["astSeatHeatState"] as? Int == 1)
            #expect(seatInfo["rlSeatHeatState"] as? Int == 1)
    ...
    func testGetBodyForCommandStartClimateGas() {
        ...
        #expect(body["airCtrl"] as? Int == 1)
        #expect(body["defrost"] as? Bool == true)
        #expect(body["heating1"] as? Bool == true)
        ...
        if let seatInfo = body["seatHeaterVentInfo"] as? [String: Any] {
            #expect(seatInfo["drvSeatHeatState"] as? Int == 3)
            #expect(seatInfo["astSeatHeatState"] as? Int == 2)
            #expect(seatInfo["rlSeatHeatState"] as? Int == 1)
            #expect(seatInfo["rrSeatHeatState"] as? Int == 1)
        }
    }
    ...
    func testGetBodyForCommandNegativeSeatValues() {
        ...
        if let seatInfo = body["seatHeaterVentInfo"] as? [String: Any] {
            #expect(seatInfo["drvSeatHeatState"] as? Int == -1)
            #expect(seatInfo["astSeatHeatState"] as? Int == -2)
        }
    }
}